...
import exceptions.exception.AgeException;
import exceptions.exception.AreaException;

public class Identifier extends Person {
    private int areaCode;
    
    public Identifier(String name, String skinColor, boolean gender, int age,  int areaCode) {
    ...
    public static void main(String[] args) {
        ...
        Identifier identify = new Identifier("Kapper", "white", true, 35, 2300);
